...
import RichTextEditor from "../forms/rich-text-edtor";
...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://tylerstwertnik.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  deleteImage(imageType) {
    axios.delete(
      ...
      this.props.handleFeaturedImageDeletion();
    }).catch(error => {
